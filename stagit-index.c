...
writefooter(FILE *fp)
{
	fputs("</tbody>\n</table>\n</div>\n"
		...
		"<p>My email is <a href=\"#\" onclick=\"return false;\">lucas@lucasburns.xyz</a> and my <a href=\"https://git.lucasburns.xyz/pgp\">PGP Key</a> can be found here, or you can run this command:</p>\n"
