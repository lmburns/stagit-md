...
writefooter(FILE *fp)
{
	fputs("</tbody>\n</table>\n</div>\n"
		...
		"<p>My email is <a href=\"#\" onclick=\"return false;\">lucas@burnsac.xyz</a> and my <a href=\"https://burnsac.xyz/pgp\">PGP Key</a> can be found here, or you can run this command:</p>\n"
		"<pre><code>curl -O https://burnsac.xyz/pgp/pkey.asc</code></pre>\n"
